...
//    public static final String PREFIX_PATH = "/v1.1/";
    ...
    public static final String WEBSERVICE_BASE_URL = "base_url.com";
//        public static final String PREFIX_PATH = "/api/";                  // uncomment when publish
    ...
    public static final String WEBSERVICE_BASE_URL_FULL ="https://base_url.com/dev";
...
//    URL constants
    ...
    public static final String URL_FORGOT_PASSWORD = "https://www.base_url.com/reset_password.php";

//    key value constants

    public static final String KEY_ACCESS_TOKEN = "access_token";
    public static final String KEY_base_url_OPENED_FOR_THE_FIRST_TIME = "base_url_opened_for_the_first_time";
...
//	other constants
    ...
    //    public static final int PAGE_SIZE_FOR_base_url_CHANNELS = 25;
    ...
    public static final String base_url_FACEBOOK_PAGE_NAME = "base_url";
    public static final String base_url_TWITTER_HANDLE_NAME = "base_url";
    public static final String base_url_TWITTER_PAGE_ID = "3252897161";
    public static final String base_url_URL_TNC = "https://www.base_url.com/tnc.php";
    public static final String base_url_URL_CONTACT_US = "2";
    ...
    public static final String UPLOADED_IMAGE_URL_PREFIX = "https://hushhash.com/images/";

    //    public static final String UPLOADED_IMAGE_URL_PREFIX = "http://mm.base_url.com/images/";
